# Generated by Django 3.0.5 on 2021-06-06 17:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveSmallIntegerField(blank=True, null=True, validators=[api.validators.year_validation], verbose_name='Year')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1, message='Please enter an integer in the range from 1 to 10'), django.core.validators.MaxValueValidator(10, message='Please enter an integer in the range from 1 to 10')])),
